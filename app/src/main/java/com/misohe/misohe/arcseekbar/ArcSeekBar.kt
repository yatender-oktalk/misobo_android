package com.misohe.misohe.arcseekbar
...
class ArcSeekBar @JvmOverloads constructor(
    ...
    private val thumb: Drawable =
        a?.getDrawable(R.styleable.ArcSeekBar_thumb) ?: resources.getDrawable(R.drawable.thumb)
    ...
    private var progressBackgroundPaint: Paint = makeProgressPaint(
        color = a.useOrDefault(resources.getColor(android.R.color.darker_gray)) {
            getColor(
    ...
    private var progressPaint: Paint = makeProgressPaint(
        color = a.useOrDefault(resources.getColor(android.R.color.holo_blue_light)) {
            getColor(
